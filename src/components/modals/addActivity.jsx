...
class AddActivity extends Component {
  ...
  renderActivities = props => {
    ...
    if (this.state.setActivity) {
      this.closeModal();
      let prevActivities = JSON.parse(
        window.localStorage.getItem("unsavedActivities")
      );
  ...
  render() {
    return (
      <div className="overlay -add-activity">
        <div className="modal">
          <h3 className="list-title -date" />
          <div className="close" onClick={this.closeModal.bind(this)} />
          <div className="activity-container">
            <ul className="activity-list">
              <li className="list-item -list-subTitle">Activities</li>
              <li
                className="list-item -sleep"
                data-id="1"
                data-name="Sleep"
                onClick={this.setActivity.bind(this)}
              >
                Sleep
              </li>
              <li
                className="list-item -school"
                data-id="2"
                data-name="School and homework"
                onClick={this.setActivity.bind(this)}
              >
                School and homework
              </li>
              ...
              <li
                className="list-item -tv"
                data-id="5"
                data-name="Watching TV"
                onClick={this.setActivity.bind(this)}
              >
                Watching TV
              </li>
          ...
          <div className="button-container -add-activity -right">
            <button
              ...
              onClick={this.renderActivities.bind(this)}
            >
              Done
            </button>
          </div>
